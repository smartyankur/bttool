...
<table>
<TR><h3><?php echo "CHD NUMBER- ".$chd_id." - ".$pro." - ".$course_title." - Testing R1 Completed"; ?></h3></TR>
...
<TR>
<TD>Subject:</TD>
<TD><input type="text" size=66 name="subject" value="<?php echo "CHD NUMBER- ".$chd_id." - ".$pro." - ".$course_title." - Testing R1 Completed"; ?>"></TD>
</TR>
</br>
...
Internal testing R1 has been completed for the course <?php echo $course_title ?>.<br><br>
