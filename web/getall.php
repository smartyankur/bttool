...
?>
<tr><th>Meeting date</th><th>Meeting Type</th><th>Participants</th><th>Meeting Title</th><th>Action Item</th><th>Owner</th><th>Target Date</th><th>Risk</th><th>Current Status</th><th>Change Status</th><th>Click To Change </th><th>Edit</th></tr>
<?php
while($row = mysql_fetch_array($result))
  ...
  <TD><input type="button" onClick="changeai(<?php echo $row['momid'] ?>)" value="Edit Action Item"></TD>
  <?php
  echo "</tr>";
  //echo "--------------------------------------------------------------------------------------------------------------------";
  }
