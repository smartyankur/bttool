...
$databases['db_actual'] = 'audit';
$databases['multi']=array();
$databases['multi_praefix']=array();
$databases['multisetting'] = '';
$databases['db_actual_tableselected'] = 'accept|actionitem|adminlogin|admintran|blob26feb|blobcopy|blobt|blobtjuly5|blobtjune03|blobtjune19|blobtmarch202013|bugreport|cabbooking|catmaster|cause|clientlogin|collateral|depheads|esat|fmtm|food|june19|june21|lmsblob|lmsblobjuly5|login|manager|manual|mommaster|pip|piphistory|preactionitem|priority|projection|projectmaster|projecttask|qcplan|qcreq|qcuploadinfo|register|reject|rootcause|scm|sheet1|subrootcause|surveylogin|surveyreport|tbl_functional_review|tbl_status|tbl_status_reason|tbl_ticket_log|ticket|total headcount|travelbooking|uploadinfo|utilization';
?>