...
xmlhttp.open("GET","updateow.php?q="+str+ "&r=" + ptr,true);
xmlhttp.send();
}
...
xmlhttp.open("GET","updateowner.php?q="+str,true);
xmlhttp.send();
}
...
<?php	
    ...
    { 
     echo "<h3>"."Hi ".$row['username']." ! You Can Change The Owner of NC Here"."<h3>";
