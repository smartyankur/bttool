...
<table>
<TR><h3><?php echo "CHD NUMBER- ".$chd_id." - ".$pro." - ".$course_title." - Build Rejected"; ?></h3><TR>
...
<TR>
<TD>Subject:</TD>
<TD><input type="text" size=66 name="subject" value="<?php echo "CHD NUMBER- ".$chd_id." - ".$pro." - ".$course_title." - Build Rejected"; ?>"></TD>
</TR>
</br>
<TR>
<TD>Message :</TD>
...
The course with the name <?php echo $course_title; ?> has been rejected.<br><br>

The course falls under the following rejection criteria:<br><br>

*****<br><br>



Please review the course again and send the updated build with the necessary review documents. QC team will then start the next round of testing on the course.<br><br>
