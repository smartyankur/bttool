...
$cquery="select * from actionitem where finding='$finding' and projectname='$project' and nctype='$nctype'";
...
$query="INSERT INTO actionitem(projectname,processarea,nctype,finding,discussiondate,targetdate,owner) values('".$project."','".$process."','".$nctype."','".$finding."','".$dtimemyformat."','".$ttimemyformat."','".$ncowner."')";
