<?php	
    ...
    { 
     echo "<h3>"."Hi ".$row['username']." ! Welcome To NC Overdue Report"."<h3>";
...
xmlhttp.open("GET","getaging.php?q="+str,true);
xmlhttp.send();
}
...
<h2>NC Report. Here You Will Find Only Those NCs Which Are Overdue.</h2>
...
<br />
<div id="txtHint"><b>Overdue ActionItems will appear here.</b></div>
<?php
mysql_close($con);
?>
</body>
