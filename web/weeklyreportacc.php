...
$selectCommon = "SELECT pt.project, pt.id as wpid, qcr.indx as reqid, qcr.status, qcr.forround, qcr.whosent, qcr.DDate FROM projecttask pt INNER JOIN qcreq qcr ON pt.id = qcr.id WHERE qcr.status = 'accepted' ORDER BY pt.project ASC";
