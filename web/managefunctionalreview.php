  ...
  if( !empty($numrowsFuncRvw) ){  
    while($fetchFuncRvw = mysql_fetch_array($queryFuncRvw)){    
      echo "<tr>";
		...
		echo "<td>"."<div align=center style="."width:75;height:100;overflow:auto>".$fetchFuncRvw['developers_id']."</div>"."</td>";
        echo "<td>"."<div align=center style="."width:75;height:100;overflow:auto>".$fetchFuncRvw['functional_manager_media']."</div>"."</td>";
		echo "<td>"."<div align=center style="."width:75;height:100;overflow:auto>".$fetchFuncRvw['developers_media']."</div>"."</td>";
        echo "<td>"."<div align=center style="."width:75;height:100;overflow:auto>".$fetchFuncRvw['functional_manager_tech']."</div>"."</td>"; 
        echo "<td>"."<div align=center style="."width:75;height:100;overflow:auto>".$fetchFuncRvw['developers_tech']."</div>"."</td>";
