...
if($s=="all")
{
 $sql="SELECT * FROM mommaster WHERE projectname = '".$q."' and type='".$r."' and meetingdate='".$t."' and participants LIKE '%$u%'";
}
else
{
 $sql="SELECT * FROM mommaster WHERE projectname = '".$q."' and type='".$r."' and status='".$s."' and meetingdate='".$t."' and participants LIKE '%$u%'";
//echo $sql;
}
