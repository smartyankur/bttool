...
$('.loader').show();
$('.loaderParent').show();
xmlhttp.open("GET","compliance.php?q="+str+"&pro_id="+pro_id, true);
xmlhttp.send();
}
...
<body>
<h2>Master Compliance Report Projectwise.</h2>
...
<input type="button" class="button" value="Show Master Compliance" onclick="showAll()">
</form>
<br />
<div id="txtHint"><b>Master Compliance Record will appear here.</b></div>
