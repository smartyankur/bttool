...
<TD><textarea name="msg" rows="4" cols="30" name="msg" id="msg"><?php echo "Response to Dev team from QC has been logged in the tool for project ".$pro;?></textarea></TD>
</TR>
</table>
