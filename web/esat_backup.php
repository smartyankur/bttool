...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
 ...
 $Q44=mysql_real_escape_string($_POST['Q44']);
 $Q45=mysql_real_escape_string($_POST['Q45']);
 ...
 $Q53=mysql_real_escape_string($_POST['Q53']);
 $Q54=mysql_real_escape_string($_POST['Q54']);
 $Q55=mysql_real_escape_string($_POST['Q55']);
 $Q56=mysql_real_escape_string($_POST['Q56']);
 $Q57=mysql_real_escape_string($_POST['Q57']);
 $Q58=mysql_real_escape_string($_POST['Q58']);
 $Q58a=mysql_real_escape_string($_POST['Q58a']);
 ...
 {
 //echo "Hello";
 $cquery="insert into esat(empid,user,Q11,Q12,Q13,Q14,Q15,Q21,Q21a,Q22,Q23,Q24,Q24a,Q25,Q26,Q31,Q31a,Q32,Q32a,Q33,Q34,Q35,Q36,Q37,Q41,Q42,Q43,Q44,Q45,Q46,Q47,Q51,Q52,Q53,Q54,Q55,Q56,Q57,Q58,Q58a,Q59,Q59a,Q510,Q511,Q511a,Q512,Q61,Q61a,Q62,Q62a,Q63,Q64,Q65,Q66,Q67)  values('$empid','$user','$Q11','$Q12','$Q13','$Q14','$Q15','$Q21','$Q21a','$Q22','$Q23','$Q24','$Q24a','$Q25','$Q26','$Q31','$Q31a','$Q32','$Q32a','$Q33','$Q34','$Q35','$Q36','$Q37','$Q41','$Q42','$Q43','$Q44','$Q45','$Q46','$Q47','$Q51','$Q52','$Q53','$Q54','$Q55','$Q56','$Q57','$Q58','$Q58a','$Q59','$Q59a','$Q510','$Q511','$Q511a','$Q512','$Q61','$Q61a','$Q62','$Q62a','$Q63','$Q64','$Q65','$Q66','$Q67')";
...
function verify()
{
 ...
 var $Q44= trim(document.getElementById('Q44').value);
 if($Q44=="Select"){alert("Please answer all the questions"); document.getElementById('Q44').focus();return false;}
 var $Q45= trim(document.getElementById('Q45').value);
 if($Q45=="Select"){alert("Please answer all the questions"); document.getElementById('Q45').focus();return false;}
 ...
 var $Q53= trim(document.getElementById('Q53').value);
 if($Q53=="Select"){alert("Please answer all the questions"); document.getElementById('Q53').focus();return false;}
 ...
 var $Q55= trim(document.getElementById('Q55').value);
 if($Q55=="Select"){alert("Please answer all the questions"); document.getElementById('Q55').focus();return false;}
 ...
 var $Q58= trim(document.getElementById('Q58').value);
 if($Q58=="Select"){alert("Please answer all the questions"); document.getElementById('Q58').focus();return false;}
 var $Q58a= trim(document.getElementById('Q58a').value);
 //if($Q58a=="Select"){alert("Please answer all the questions"); document.getElementById('Q58a').focus();return false;}
 if($Q58=="Somewhat Agree" && $Q58a=="" || $Q58=="Strongly Agree" && $Q58a=="" ) {alert("Please enter comment"); document.getElementById('Q58a').focus();return false;}
...
<input type="hidden" name="Q44" id="Q44" value="Disagree">
<!--
<TR>
<TD>Q4</TD><TD>I have a mentor at work through Paramarsh program.</TD>
<TD><select name="Q44" id="Q44" size="1">
<option selected>Select</option>
<option value="Disagree">Disagree</option>
<option value="Somewhat Disagree">Somewhat Disagree</option>
<option value="Neutral">Neutral</option>
...
<input type="hidden" name="Q45" id="Q45" value="NULL">
<!--
<TR>
<TD>Q5</TD><TD>I feel the need but do not seem to find the right mentor.</TD>
<TD><select name="Q45" id="Q45" size="1">
<option selected>Select</option>
<option value="Disagree">Disagree</option>
<option value="Somewhat Disagree">Somewhat Disagree</option>
<option value="Neutral">Neutral</option>
...
<input type="hidden" name="Q53" id="Q53" value="Disagree">
<!-- 
<TR>
<TD>Q3</TD><TD>The management does what is best for G-Cube</TD>
<TD><select name="Q53" id="Q53" size="1">
<option selected>Select</option>
<option value="Disagree">Disagree</option>
<option value="Somewhat Disagree">Somewhat Disagree</option>
<option value="Neutral">Neutral</option>
...
<input type="hidden" name="Q55" id="Q55" value="NULL">
<!--
<TR>
<TD>Q5</TD><TD>I can rely upon what other associates tell me at work</TD>
<TD><select name="Q55" id="Q55" size="1">
<option selected>Select</option>
<option value="Disagree">Disagree</option>
<option value="Somewhat Disagree">Somewhat Disagree</option>
<option value="Neutral">Neutral</option>
...
<input type="hidden" name="Q58" id="Q58" value="NULL">
<input type="hidden" name="Q58a" id="Q58a" value="NULL">
<!--
<TR>
<TD>Q8</TD><TD>Do you view problems at work as a challenge and a reason to excel? Support with an example, if you choose somewhat agree or strongly agree.</TD>
<TD><select name="Q58" id="Q58" size="1">
<option selected>Select</option>
<option value="Disagree">Disagree</option>
<option value="Somewhat Disagree">Somewhat Disagree</option>
<option value="Neutral">Neutral</option>
...
<TR>
<TD>Q8a</TD><TD>Comment.</TD><TD><textarea name="Q58a" id="Q58a" rows="3" cols="30"></textarea></TD>
</TR>
-->
